...
void job::write_page_header() {
  fprintf(out_, "\033%%-12345X@PJL\n");
  // KONICA MINOLTA bizhub 2600P/3000MF/3080MF accept a plain
  // RESOLUTION=1200 token for the HQ1200 mode (the upstream brlaser
  // RAS1200MODE token is not present in the OEM filter for these models).
